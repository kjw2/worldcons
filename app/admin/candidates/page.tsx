...
import { Ban, ExternalLink, LogOut, RefreshCw, RotateCcw, Search } from "lucide-react";
    ...
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-normal text-ink">URL 후보</h1>
