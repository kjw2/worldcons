/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/browser-run/wrangler.jsonc --strict-vars=false workers/browser-run/worker-configuration.d.ts` (hash: c243007d67829a0beabc75914ca281b6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BROWSER_ALLOWED_HOSTS" | "BROWSER_RUN_TOKEN">> {}
}
