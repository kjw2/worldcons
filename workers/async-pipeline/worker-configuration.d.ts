/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/async-pipeline/wrangler.jsonc --strict-vars=false workers/async-pipeline/worker-configuration.d.ts` (hash: d2dc40f6615a669b632674852deb80b2)
// Runtime types generated with workerd@1.20260918.1 2026-09-26 nodejs_compat
interface __BaseEnv_Env {
	ASYNC_QUEUE: Queue;
	M8_SCHEDULER_ENABLED: string;
	M8_ENABLED_KINDS: string;
	GITHUB_REPOSITORY: string;
	GITHUB_REF: string;
	GITHUB_ACTIONS_TOKEN: string;
	ASYNC_WORKFLOW: Workflow<Parameters<import("./src/index").WorldconsAsyncWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "M8_SCHEDULER_ENABLED" | "M8_ENABLED_KINDS" | "GITHUB_REPOSITORY" | "GITHUB_REF" | "GITHUB_ACTIONS_TOKEN">> {}
}
