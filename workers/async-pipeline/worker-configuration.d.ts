/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/async-pipeline/wrangler.jsonc --strict-vars=false workers/async-pipeline/worker-configuration.d.ts` (hash: 7926f0fdd92aedb3ef47ac3ffc03a48a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "M8_SCHEDULER_ENABLED" | "GITHUB_REPOSITORY" | "GITHUB_REF" | "GITHUB_ACTIONS_TOKEN">> {}
}
