...
- Resolved failures and no-ops, including `{ ok: false }`, unavailable, incomplete, skipped, invalid, not-found, no-database, null-result, zero-work worker drain, and empty glossary refresh outcomes, return unchanged with `shadow: "skipped"` and do not submit.
