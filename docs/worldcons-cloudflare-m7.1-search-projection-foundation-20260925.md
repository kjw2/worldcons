...
M7.2 `public_fulltext_ranked_ids_v1` / `worldcons_ranked_search_page_v1` filters
...
`tests/d1-search-projection.test.ts` (12 focused tests) covers:
...
- No FTS5 rank/weight parity is claimed (deferred to M7.2).
- No Vectorize / semantic authority (M7.2+).
