...
paging and no-threshold behavior. **The M7.7-A migration is still NOT applied;
no Supabase row was mutated; `SearchRepository`/`GO-SEARCH`/DNS/traffic are
unchanged; no deployment.** See
`docs/worldcons-cloudflare-m7.7-semantic-authority-and-fulltext-rank-policy-20260926.md`.
