    ...
    <form action={action} className={cn("flex w-full items-center gap-2", isHero ? "max-w-3xl" : "")}>
      ...
      <label className="relative min-w-0 flex-1">
        ...
        <input
          ...
          className={cn(
            "focus-ring w-full rounded-lg border border-line bg-white shadow-card outline-none placeholder:text-ink-subtle",
      ...
      <button
        type="submit"
        className={cn(
          "focus-ring inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-primary font-semibold text-white shadow-sm transition hover:bg-primary/90",
