...
const articles: TableSpec = {
  ...
  columns: [
    ...
    { name: "slug", type: "text", nn: true },
    {
      ...
      type: "text",
      relocate: "r2",
      note: "stored in R2; the row keeps the raw_text_storage_ref / raw_text_blob_hash / raw_text_blob_size / raw_text_externalized_at / raw_text_blob_contract_version metadata (plan 7.3)",
    },
    { name: "cleaned_text", type: "text", note: "cleaned text stays inline in D1 (plan 7.3)" },
...
const articleContentVersionsP3: TableSpec = {
  ...
  database: "worldcons_core",
  primaryKey: ["id"],
  note: "immutable article version snapshots; raw_text relocates to R2, search_vector to worldcons_search FTS5, and embedding to Vectorize",
  indexes: [
